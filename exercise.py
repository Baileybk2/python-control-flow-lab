...
def determine_season():
    ...
    winter = (month == 'Dec' and day >= 21) or month in ['Jan', 'Feb'] or (month == 'Mar' and day <= 19)
    spring = (month == 'Mar' and day >= 20) or month in ['Apr', 'May'] or (month == 'Jun' and day <= 20)
    summer = (month == 'Jun' and day >= 21) or month in ['Jul', 'Aug'] or (month == 'Sep' and day <= 21)
    fall = (month == 'Sep' and day >= 22) or month in ['Oct', 'Nov'] or (month == 'Dec' and day <= 20)
